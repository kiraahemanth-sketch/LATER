...
BOT_TOKEN = environ.get('BOT_TOKEN', '8212814456:AAHnsLWNQ_S85DP3ZJWXZXllTFjDNEQRLFU')
if len(BOT_TOKEN) == 0:
...
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://botskingdom2:t7ognZuINrNfH3tj@cluster0.ystdy4m.mongodb.net/?retryWrites=true&w=majority')
...
if len(UPSTREAM_REPO) == 0:
    UPSTREAM_REPO = "https://github.com/kiraahemanth-sketch/LATER"
